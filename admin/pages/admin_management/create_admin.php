...
<body class="d-flex flex-column">
    ...
    <main class="d-flex flex-row w-100 p-2 gap-2 flex-grow-1 align-items-stretch"">
        ...
        <ul class="nav d-flex flex-column sidebar-nav gap-2">
            ...
            <li class="nav-item"><a class="nav-link sidebar-link" href="admins.php">Admins</a></li>
        ...
        <div class="main-content d-flex flex-column w-100 p-2 gap-2 flex-grow-1">
            ...
            <form class="d-flex flex-column gap-2 w-100" method="POST" action="../../../api/admin/admins.php">
                ...
                <input class="btn btn-success w-25" type="submit" value="Create Admin">
            </form>

            <a class="btn btn-outline-primary w-25" href="admins.php">Back</a>
