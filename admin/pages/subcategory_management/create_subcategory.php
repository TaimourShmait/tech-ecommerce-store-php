...
<body class="d-flex flex-column">
    ...
    <main class="d-flex flex-row w-100 p-2 gap-2 flex-grow-1 align-items-stretch"">
        ...
        <div class="main-content d-flex flex-column w-100 p-2 gap-2 flex-grow-1">
            ...
            <p>Create New Subcategory</p>

            <form class="d-flex flex-column gap-2 w-100" method="POST" action="../../../api/admin/subcategories.php">
                <input type="hidden" value="create" name="action">
                <input class="form-control" type="text" placeholder="Subcategory Name" name="name" required>
                <select class="form-select" name="category" id="subcategory-select">
                ...
                <input class="btn btn-success w-25" type="submit" value="Create Subcategory">
            </form>

            <a class="btn btn-outline-primary w-25" href="subcategories.php">Back</a>
